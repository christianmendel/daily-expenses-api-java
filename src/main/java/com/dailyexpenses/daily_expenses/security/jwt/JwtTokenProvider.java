package com.dailyexpenses.daily_expenses.security.jwt;
...
public class JwtTokenProvider {
    ...
    public Token createAccessToken(Long id,String username, List<String> roles) {
        Date now = new Date();
        Date validity = new Date(now.getTime() + validityInMilliseconds);
        String accessToken = getAccessToken(username, roles, now, validity);
        String refreshToken = getRefreshToken(id, username, roles, now);
    ...
    public Token refreshToken(String refreshToken) {
        ...
        return createAccessToken(id, username, roles);
    }

    private String getRefreshToken(Long id, String username, List<String> roles, Date now) {
